...
class NavService extends ContainerAware
{
    ...
    public function putTheOrderToTheNAV(Order $order)
    {
        ...
        $dataToPut = array(
            ...
            'City' => 'Kaunas', //$order->getAddressId()->getCity(),
            'Street' => ($order->getDeliveryType() == OrderService::$deliveryDeliver ? $orderRow->getStreetName(): 'Savanoriu'),
            'Street No_' => ($order->getDeliveryType() == OrderService::$deliveryDeliver ? $orderRow->getNumberFrom(): '302'),
            'Floor' => '',
            ...
            'Restaurant No_' => ($order->getDeliveryType() == OrderService::$deliveryDeliver ? '': 'C30'),
