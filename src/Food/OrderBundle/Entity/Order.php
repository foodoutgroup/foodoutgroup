    ...
    public function getLateMinutes()
    {
        ...
        switch($this->getOrderStatus()) {
            ...
            case OrderService::$status_assiged:
                ...
                @mail("karolis.m@foodout.lt", "LATE TIME".date("Y-m-d H:i:s"), 'NowStamp: '.$nowStamp.' DeliveryStamp: '.$deliveryStamp.' DiffMinutes: '.$diffMinutes, "FROM: info@foodout.lt");
                break;
        ...
        switch($this->getOrderStatus()) {
            ...
            case OrderService::$status_assiged:
                if ($this->getDeliveryTime()->format('d H:i') < date('d H:i')) {
                    @mail("karolis.m@foodout.lt", "LATE ".date("Y-m-d H:i:s"), $this->getDeliveryTime()->format('d H:i').' < '.date('d H:i'), "FROM: info@foodout.lt");
                    return true;
                }
                break;
