...
class SendigoService extends ContainerAware
{
    private $fromName;
    ...
    /**
{
   ...
   "recipients":[
    ...
    public function send()
    {
        ...
        $ch = curl_init('https://api.sendigo.com/transaction/categorizedtask');
    ...
    public function getTemplate()
    {
        ...
        $ch = curl_init('https://api.sendigo.com/template/get');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_POST, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $data);
        $output = curl_exec($ch);
