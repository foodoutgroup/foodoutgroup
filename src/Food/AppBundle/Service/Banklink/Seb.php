...
use Food\AppBundle\Service\Banklink\AbstractBanklink;
...
class Seb extends AbstractBanklink
{
    ...
    private $fields = [
        static::REDIRECT_SERVICE => ['VK_SERVICE',
                                     'VK_VERSION',
                                     'VK_SND_ID',
                                     'VK_STAMP',
                                     'VK_AMOUNT',
                                     ...
                                     'VK_REF',
                                     'VK_MSG'],
        static::SUCCESS_SERVICE => ['VK_SERVICE',
                                    'VK_VERSION',
                                    'VK_SND_ID',
                                    'VK_REC_ID',
                                    'VK_STAMP',
                                    ...
                                    'VK_MSG',
                                    'VK_T_DATE'],
        static::FAILURE_SERVICE => ['VK_SERVICE',
                                    'VK_VERSION',
                                    'VK_SND_ID',
                                    'VK_REC_ID',
                                    'VK_STAMP',
