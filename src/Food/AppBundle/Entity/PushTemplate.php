 ...
 * City
 *
 * @ORM\Table(name="push_template")
 * @ORM\Entity(repositoryClass="Food\AppBundle\Entity\PushTemplateRepository")
 * @Gedmo\TranslationEntity(class="Food\AppBundle\Entity\PushTemplateLocalized")
...
class PushTemplate
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Food\AppBundle\Entity\PushTemplateLocalized", mappedBy="object", cascade={"persist", "remove"})
     **/
     ...
     * Add translations
     *
     * @param PushTemplateLocalized $t
     */
    public function addTranslation(PushTemplateLocalized $t)
    {
     ...
     * Remove translations
     *
     * @param PushTemplateLocalized $translations
     */
    public function removeTranslation(PushTemplateLocalized $translations)
    {
