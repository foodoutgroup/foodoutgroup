...
class PlacePointFullAdmin extends FoodAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('city_id','city',array('label'=>'admin.point.city'))
            ...
            ->add('phoneSend', null, array('label' => 'admin.point.phone_send', 'required' => false))
            ->add('alt_phone1', 'text', array('label' => 'admin.point.alt_phone', 'required' => false, 'attr' => array('placeholder'=>'370xxxxxxx')))
            ->add('altPhone1Send', null, array('label' => 'admin.point.phone_send', 'required' => false))
            ->add('alt_phone2', 'text', array('label' => 'admin.point.alt_phone', 'required' => false, 'attr' => array('placeholder'=>'370xxxxxxx')))
            ->add('altPhone2Send', null, array('label' => 'admin.point.phone_send', 'required' => false))
            ->add('email', 'text', array('label' => 'admin.point.email', 'required' => false))
            ->add('emailSend', null, array('label' => 'admin.point.email_send', 'required' => false))
            ->add('alt_email1', 'text', array('label' => 'admin.point.alt_email', 'required' => false))
            ->add('altEmail1Send', null, array('label' => 'admin.point.email_send', 'required' => false))
            ->add('alt_email2', 'text', array('label' => 'admin.point.alt_email', 'required' => false))
            ->add('altEmail2Send', null, array('label' => 'admin.point.email_send', 'required' => false))
...
//            ->add('syncFormat', 'choice', array('choices' => ['application/xml', 'application/json'], 'label' => 'admin.point.sync_format', 'required' => false))
