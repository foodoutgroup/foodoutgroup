...
class DefaultController extends Controller
{
    protected $cityTranslations = [
        ...
        'Rīga' => 'places.in_riga',
        'Ogre' => 'places.in_ogre',
        'Jurmala' => 'places.in_jurmala',
        'Jelgava' => 'places.in_jelgava',
        'Tallinn' => 'places.in_tallinn',
        'Haabersti' => 'places.in_tallinn',
        'Jarvekula' => 'places.in_tallinn',
        'Järveküla' => 'places.in_tallinn',
        'Kesklinn' => 'places.in_tallinn',
        'Kristiine' => 'places.in_tallinn',
        'Lasnamae' => 'places.in_tallinn',
        'Lasnamäe' => 'places.in_tallinn',
        'Mustamae' => 'places.in_tallinn',
        'Mustamäe' => 'places.in_tallinn',
        'Nomme' => 'places.in_tallinn',
        'Nõmme' => 'places.in_tallinn',
        'Oismae' => 'places.in_tallinn',
        'Õismäe' => 'places.in_tallinn',
        'Peetri' => 'places.in_tallinn',
        'Pirita' => 'places.in_tallinn',
        'Pohja-Tallinn' => 'places.in_tallinn',
        'Põhja-Tallinn' => 'places.in_tallinn',
        'Viimsi' => 'places.in_tallinn',
    ];
