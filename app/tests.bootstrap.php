...
/* clear previous data */
passthru('php app/console doctrine:schema:drop --env=test --force --quiet');
passthru('php app/console doctrine:schema:create --env=test --quiet');
passthru('php app/console doctrine:fixtures:load --env=test --no-interaction');
